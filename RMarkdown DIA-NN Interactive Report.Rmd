...
abundances$sample <- gsub('_dia_23_276',
                          '',
                          abundances$sample)
### Number of Peptides -------------------------------------------------------
...
n_peptides$sample <- gsub('_dia_23_276',
                          '',
                          n_peptides$sample)
...
```{r heatmap_data_prep, message=FALSE, warning=FALSE}
...
```{r render_cv_plot, message=FALSE}
...
```{r intensity_prep, message=FALSE, warning=FALSE}
...
```{r render_intensity_plot,message=FALSE, warning=FALSE}
...
```{r prepare_PCA, warning=FALSE, message=FALSE}
...
```{r render_PCA, message=FALSE, warning=FALSE}
...
```{r, volcano_plot_prep, warning=FALSE, message=FALSE}
...
volcano_plot <- data %>%
   ...
   labs(x = 'log2 Fold Change (WT/KO)',
        y = '-log10 p-Value (WT/KO)') +
   ## Make cutoff lines ---- 
...
```{r render_volcano_plot, warning=FALSE, message=FALSE}
